            ...
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h4 class="modal-title">supprimer le statut ?</h4>
                    ...
                    <div class="modal-body">
                        ...
                        <p class="text-center">
                            Voulez-vous supprimer le statut des enregistrements ?
                        </p>
                    </div>

                    <!-- Modal footer -->
                    <div class="modal-footer" style="text-align: center !important">
                        <form action="" data-url="{{ adminUrl('statuses') }}" method="post" style="display: none"
                            id="form-delete">
                            @csrf
                            @method('delete')
                        </form>
