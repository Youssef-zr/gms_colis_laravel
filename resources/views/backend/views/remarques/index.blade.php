            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><i class="fa fa-file"></i> {{ $title }}</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                        ...
                        <div class="card-body">
                           <!-- btns action -->
                            <div class="btn p-0" id="actions">
                                {{-- @can('ajouter_colis') --}}
                                <div class="btn-group">
                                    <a href="{{ adminUrl('remarques/create') }}" class="btn btn-primary add mr-2 rounded"
                                            ...
                                            <table id="example" class="stripe row-border order-column" style="width:100%">
                                                ...
                                                <tbody>
                                                    @foreach ($remarques as $remarque)
                                                        <tr>
                                                            <td>{{ $remarque->id_remarques }}</td>
                                                            <td>{{ $remarque->libelle }}</td>
                                                            <td>
                                                                <div class="btn-group">

                                                                    {{-- @can('editer_remarque') --}}
                                                                    <a href="{{ adminUrl('remarques/' . $remarque->id_remarques . '/edit') }}"
                                                                    ...
                                                                    {{-- @can('supprimer_remarque') --}}
                                                                    {{-- @if ($remarque->id_remarques > 10) --}}
                                                                    <a href="#"
                                                                        class="btn btn-danger bg-maroon btn-sm text-left delete"
                                                                        data-id="{{ $remarque->id_remarques }}"
            ...
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h4 class="modal-title">supprimer la remarque ?</h4>
                    ...
                    <div class="modal-body">
                        ...
                        <p class="text-center">
                            Voulez-vous supprimer la remarque des enregistrements ?
                        </p>
                    </div>

                    <!-- Modal footer -->
                    <div class="modal-footer" style="text-align: center !important">
                        <form action="" data-url="{{ adminUrl('remarques') }}" method="post" style="display: none"
                            id="form-delete">
                            @csrf
                            @method('delete')
                        </form>
    ...
    <script>
        $(document).ready(function() {
            ...
            setTimeout(() => {
                ...
                $('#example_filter').css({marginRight:"15px"});
