            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><i class="fa fa-power-off"></i> {{ $title }}</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
...
@section('content')
    <div class="box text-capitalize px-3">
        ...
        <div class="box-header mb-3 text-right">
            {{-- @can('ajouter_statut') --}}
                <a href="{{ route('statuses.create') }}" class="btn btn-primary btn-sm add" data-toggle="tooltip"
                    title=" Nouveau remarque">
            ...
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    ...
                    <div class="modal-footer" style="text-align: center !important">
                        <form action="" data-url="{{ adminUrl('notes') }}" method="post" style="display: none"
                            id="form-delete">
                            @csrf
                            @method('delete')
                        </form>
